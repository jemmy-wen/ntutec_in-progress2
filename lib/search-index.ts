...
const PAGES: SearchItem[] = [
  ...
  {
    title: "新創投遞",
    description: "投遞創業計畫給天使投資俱樂部，接受盡調評估",
    href: "/pitch",
    category: "頁面",
  ...
  {
    title: "常見問題",
    description: "申請、計畫、天使俱樂部與企業合作的常見問題解答",
    href: "/faq",
    category: "頁面",
...
const FAQS: SearchItem[] = [
  ...
  { title: "計畫結束後還能獲得什麼支持？", description: "畢業團隊可持續參與校友網絡活動、業師諮詢，以及天使投資俱樂部的募資機會", href: "/faq", category: "常見問題", keywords: ["畢業", "校友", "後續", "支持"] },
  ...
  { title: "新創團隊要如何接觸天使投資俱樂部？", description: "透過官網投遞表單申請，無需事先參加加速器或車庫計畫", href: "/faq", category: "常見問題", keywords: ["天使", "新創", "投遞", "募資"] },
