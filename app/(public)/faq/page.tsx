...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "畢業團隊可持續參與中心的校友網絡活動、業師諮詢，以及台大天使會的募資機會。台大車庫畢業團隊享有台大加速器的優先申請資格。中心持續與歷屆校友保持連繫，在創投與企業合作機會上協助媒合。",
  },
  {
    category: "計畫相關",
  ...
  },
  {
    ...
    question: "如何成為天使會會員？",
    answer:
      "有意加入者可透過官網填寫入會諮詢表單，或直接聯繫投資經理。中心將安排一對一諮詢，說明入會條件、年費結構與會員權益。台大天使會以質量為優先，名額有限。",
  ...
  {
    category: "台大天使會",
    question: "新創團隊要如何接觸台大天使會？",
    answer:
      "新創團隊可隨時透過官網投遞表單申請接觸台大天使會，無需事先參加台大加速器或台大車庫計畫。所有投遞案件將由中心投資團隊進行初步審查，通過者安排進一步盡調，再推薦至天使例會。曾參與台大輔導計畫的校友團隊享有優先推薦資格。",
