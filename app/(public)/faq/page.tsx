...
const faqs: FaqItem[] = [
  // ── 計畫相關 ──────────────────────────────────────────────────────────
  {
    ...
    answer:
      "台大加速器適合已有 MVP 或初期營收的成長期新創，為期十個月（3月至12月），提供深度導師一對一輔導、企業資源對接與募資機會，不限台大身分。台大車庫適合概念驗證至 MVP 階段的早期團隊，提供免費共創空間與社群支持，以台大身分優先，特殊情況可個案評估。",
  },
  {
    category: "計畫相關",
  ...
  },
  {
    ...
    answer:
      "畢業團隊可持續參與中心的校友網絡活動、導師諮詢，以及天使投資俱樂部的募資機會。台大車庫畢業團隊享有台大加速器的優先申請資格。我們也長期追蹤校友成長，協助對接創投與企業合作機會。",
  },
  {
    category: "計畫相關",
  ...
  // ── 天使俱樂部 ────────────────────────────────────────────────────────
  {
    ...
    answer:
      "NTUTEC ANGELS 是台大創創中心於 2023 年成立的天使投資社群，匯聚 150+ 位投資人，每月定期舉辦天使例會，提供會員經過三段嚴格篩選的優質早期案源、導師網絡與投資人交流場域。",
  },
  {
    category: "天使投資俱樂部",
    question: "如何成為天使會會員？",
  ...
  {
    category: "導師與輔導",
    question: "導師如何輔導新創？頻率是？",
    answer:
      "中心配對導師與入選新創進行每月一對一深度輔導，聚焦商業策略、市場進入、技術驗證或募資準備。導師均具備 15 年以上產業或創投經驗，依新創需求彈性調整輔導重點。",
  },
  {
    category: "導師與輔導",
    question: "如何成為台大創創中心導師？",
    answer:
      "若您具備創業、投資、技術或產業管理經驗，有意回饋創業生態系，歡迎填寫導師申請表或直接聯繫中心。導師遴選以與中心聚焦領域的契合度與實戰經驗為主要依據。",
  },
  {
    category: "導師與輔導",
  ...
  },
  {
    ...
    answer:
      "有。TEC Talk 是台大創創中心的官方 Podcast，自 2021 年開播，邀請導師、知名創業者與產業專家分享第一線的創業經驗、投資觀點與產業趨勢。可在 Firstory、Spotify 等主流平台收聽，或透過官網部落格瀏覽文字版內容。",
  },
];
  ...
  return (
    <>
      <PageHero
        title="常見問題"
        subtitle="FAQ"
        description="關於計畫申請、天使投資、企業合作、導師輔導與其他常見疑問的完整解答。"
      />
