...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "台大車庫與台大加速器均為免費計畫，不收取任何費用，也不要求股權。台大創創中心以促進台大創業生態系為使命，不以營利為目的。",
  },
  {
    category: "計畫相關",
  ...
  },
  {
    ...
    answer:
      "台大車庫與台大加速器均採虛擬進駐模式，不要求固定座位或全程駐點。兩者皆以定期輔導會議與活動出席為主，學員可使用中心會議室與活動場地，彈性配合創業節奏。",
  },
  {
    category: "計畫相關",
  ...
  // ── 天使俱樂部 ────────────────────────────────────────────────────────
  {
    ...
    answer:
      "NTUTEC ANGELS 是台大創創中心於 2023 年成立的天使投資社群，匯聚 40+ 位付費天使會員（150+ 投資人網絡），每月定期舉辦天使例會，提供會員經過三段嚴格篩選的優質早期案源、業師網絡與投資人交流場域。",
  },
  {
    category: "天使投資俱樂部",
    question: "如何成為天使會會員？",
  ...
  },
  {
    ...
    answer:
      "天使例會每月定期舉辦，由新創團隊進行 Pitch 與 Q&A。會員以個人資金直接投資，不受機構共投限制；投資金額視會員與新創各案洽談，最低投資金額通常落於 100–1,500 萬元新台幣。",
  },
  {
    category: "天使投資俱樂部",
