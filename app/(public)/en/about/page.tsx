...
const milestones = [
  ...
  { year: '2019', title: 'Corporate Vertical Accelerator Pioneer', description: 'Pioneered the Corporate Vertical Accelerator model — corporations define challenges, startups solve them. Cumulatively partnered deeply with 35 companies spanning technology, manufacturing, finance, and media sectors.' },
