/**
 * NTUTEC Angel Corporate Membership Form — Apps Script Webhook
 *
 ...
 *
 * Webhook endpoint: POST /api/webhook/angel-corporate
 */

var WEBHOOK_URL = 'https://YOUR_DOMAIN/api/webhook/angel-corporate';
